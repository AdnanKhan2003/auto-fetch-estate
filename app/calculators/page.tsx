                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      value={areaVal}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setAreaVal(e.target.value)}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      value={generalArea}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setGeneralArea(e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      max={1.0}
                      value={customFactor}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setCustomFactor(e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      value={estimatorRate}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEstimatorRate(e.target.value)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      value={loanTenure}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setLoanTenure(e.target.value)}
                      placeholder="e.g. 20"
                      className="h-11 rounded-lg border-border"
                    />
                  </div>
